        ...
        <div className="modal" id="productModal">
            <div className="modal-dialog">
                ...
                <div className="modal-body">
                    ...
                    <p>
                    <del className="text-muted">原價 ${currency(product.origin_price)}</del>，特價：${currency(product.price)}
                    </p>
                ...
                <div className="modal-footer">
                    <button type="button" className="btn btn-warning" onClick={() => handleAddCart()}>
                    加入購物車
                    </button>
                </div>
                </div>
